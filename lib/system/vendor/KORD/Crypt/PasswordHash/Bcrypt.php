...
use KORD\Helper\RandomInterface;

/**
 * @copyright Copyright (c) 2005-2014 Zend Technologies USA Inc. (http://www.zend.com)
 * @copyright  (c) 2014 Andriy Strepetov
 */
class Bcrypt implements PasswordHashInterface
{
     ...
     */
    public function __construct(RandomInterface $random, array $config = null)
    {

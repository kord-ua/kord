 ...
 */
class Group extends \ArrayObject implements GroupInterface
{
     ...
     *
     * @param \KORD\Config\RepositoryInterface  $instance "Owning" instance of \KORD\Config\Repository
     * @param string         $group    The group name
     * @param array          $config   Group's config
     */
    public function __construct(RepositoryInterface $instance, $group, array $config = [])
    {

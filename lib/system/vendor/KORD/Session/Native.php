 ...
 */
class Native extends SessionAbstract
{
    ...
    protected function readSession($id = null)
    {
        ...
        } elseif ($this->encrypt !== null) {
            // Decrypt the data using the default key
            $_SESSION['SESSION_DATA'] = $this->unserialize($this->encrypt->decode($_SESSION['SESSION_DATA']));
        }
    ...
    protected function writeSession()
    {
        if ($this->encrypt !== null) {
            ...
            $this->data = $this->encrypt->encode($this->serialize($this->data));
        }

...
<div id="kord_error">
	<h1><span class="type"><?php echo $class ?> [ <?php echo $code ?> ]:</span> <span class="message"><?php echo htmlspecialchars( (string) $message, ENT_QUOTES, $charset, true); ?></span></h1>
	...
	<div id="<?php echo $env_id ?>" class="content collapsed">
		...
		<div id="<?php echo $env_id ?>" class="collapsed">
			<table cellspacing="0">
				...
				<tr>
					<td><code><?php echo htmlspecialchars( (string) $key, ENT_QUOTES, $charset, true); ?></code></td>
